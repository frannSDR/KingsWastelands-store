<div class="section-container">
    ...
    <div class="top-container">
        <div class="cat-title">
            <p>Accion</p>
            <img src="https://i.ibb.co/4ZJJTr7h/accion.png" alt="Terror" class="cat-image">
        </div>
    </div>
    ...
    <div class="games-container">
        <div class="game-card">
            <div class="media-container">
                <img src="https://i.ibb.co/WvW8Vt0G/doometernal.png" alt="Monster Hunter: Wilds" class="game-image">
        ...
        <div class="game-card">
            <div class="media-container">
                <img src="https://i.ibb.co/21Kjjn6r/dmc5.jpg" alt="Kingdom Come: Deliverance II" class="game-image">
                <div class="game-trailer">
        ...
        <div class="game-card">
            <div class="media-container">
                ...
                <img src="https://i.ibb.co/dJ5NtdVH/cp77.png" alt="Path of Exile II" class="game-image">
                <div class="game-trailer">
        ...
        <div class="game-card">
            <div class="media-container">
                <img src="https://i.ibb.co/5X2cFGMR/bioinfinite.png" alt="Stardew Valley" class="game-image">
                <div class="game-trailer">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/WYRePGtK074?si=hT1LC6wRToLqTZme&amp;start=10&amp;controls=0&amp;autoplay=0&amp;mute=1&amp;enablejsapi=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
            <div class="game-info">
                <div class="game-title">Bioshock Infinite</div>
                <div class="game-price">$14.99</div>
            </div>
        </div>
        <div class="game-card">
            <div class="media-container">
                <img src="https://i.ibb.co/VYjhMxw2/aw2.png" alt="EA FC 25" class="game-image">
                <div class="game-trailer">
