<div class="section-container">
    ...
    <div class="top-container2">
        <div class="cat-title">
            <p>Indies</p>
            <img src="https://i.ibb.co/bRDxSFVG/indies.png" alt="Terror" class="cat-image">
        </div>
    </div>
    ...
    <div class="games-container">
        <div class="game-card">
            <div class="media-container">
                <img src="https://i.ibb.co/Hc5dS8S/hk.png" alt="Monster Hunter: Wilds" class="game-image">
        ...
        <div class="game-card">
            <div class="media-container">
                ...
                <img src="https://i.ibb.co/whGtFLjB/undertale.jpg" alt="Path of Exile II" class="game-image">
                <div class="game-trailer">
        ...
        <div class="game-card">
            <div class="media-container">
                <img src="https://i.ibb.co/TxCL4VKF/wroef.jpg" alt="EA FC 25" class="game-image">
                <div class="game-trailer">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/YKRhE5hcG_E?si=BWqqm8NXEstUvzPq&amp;start=10&amp;controls=0&amp;autoplay=0&amp;mute=1&amp;enablejsapi=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
            <div class="game-info">
                <div class="game-title">What Remains of Edith Finch</div>
