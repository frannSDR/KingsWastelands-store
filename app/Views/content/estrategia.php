<div class="section-container">
    ...
    <div class="top-container">
        <div class="cat-title">
            <p>Estrategia</p>
            <img src="https://i.ibb.co/W4N13s6s/estrategia.png" alt="Terror" class="cat-image">
        </div>
    </div>
    ...
    <div class="games-container">
        <div class="game-card">
            <div class="media-container">
                <img src="https://i.ibb.co/TxjmLssc/aoe4.jpg" alt="Monster Hunter: Wilds" class="game-image">
        ...
        <div class="game-card">
            <div class="media-container">
                ...
                <img src="https://i.ibb.co/PzPgDHLC/human.png" alt="Path of Exile II" class="game-image">
                <div class="game-trailer">
            ...
            <div class="game-info">
                <div class="game-title">Humankind</div>
                <div class="game-price">$45.99</div>
            </div>
        </div>
        <div class="game-card">
            <div class="media-container">
                <img src="https://i.ibb.co/tpJMHsHc/mbb.jpg" alt="Stardew Valley" class="game-image">
                <div class="game-trailer">
